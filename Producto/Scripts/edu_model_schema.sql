...
\restrict A7VrgD6P2CW7etWzol96bVWxnCyt6qbOgyoDwyqBhf5YPad9mDIOiuaXivJsXEB
...
--
-- Name: anotaciones; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.anotaciones (
    ...
    id_profesor uuid,
    texto text NOT NULL,
    tipo character varying(20) DEFAULT 'observacion'::character varying,
...
--
-- Name: anotaciones_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: anotaciones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: apoderado_alumno; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.apoderado_alumno (
    id integer NOT NULL,
    id_apoderado uuid NOT NULL,
    id_alumno integer NOT NULL,
    parentesco text DEFAULT 'Apoderado'::text
);


--
-- Name: apoderado_alumno_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.apoderado_alumno_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: apoderado_alumno_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.apoderado_alumno_id_seq OWNED BY public.apoderado_alumno.id;
...
CREATE TABLE public.asistencia (
    ...
    justificacion text,
    CONSTRAINT asistencia_estado_check CHECK ((estado = ANY (ARRAY['presente'::text, 'ausente'::text, 'tardanza'::text])))
);
...
CREATE TABLE public.colegios (
    ...
    plan_expira date,
    CONSTRAINT chk_plan CHECK (((plan)::text = ANY ((ARRAY['basico'::character varying, 'profesional'::character varying, 'enterprise'::character varying])::text[])))
);
...
--
-- Name: curso_asignatura_profesor; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.curso_asignatura_profesor (
    id integer NOT NULL,
...
--
-- Name: curso_asignatura_profesor_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.curso_asignatura_profesor_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: curso_asignatura_profesor_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.curso_asignatura_profesor_id_seq OWNED BY public.curso_asignatura_profesor.id;
...
CREATE TABLE public.horarios (
    ...
    bloque_fin time without time zone NOT NULL,
...
--
-- Name: muro_avisos; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.muro_avisos (
    id integer NOT NULL,
    id_curso integer,
    id_autor uuid,
    titulo text NOT NULL,
...
--
-- Name: muro_avisos_nuevo_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.muro_avisos_nuevo_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: muro_avisos_nuevo_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.muro_avisos_nuevo_id_seq OWNED BY public.muro_avisos.id;
...
--
-- Name: notas_historial; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.notas_historial (
    id integer NOT NULL,
...
--
-- Name: notas_historial_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.notas_historial_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: notas_historial_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.notas_historial_id_seq OWNED BY public.notas_historial.id;
...
--
-- Name: solicitudes_plan; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.solicitudes_plan (
    id integer NOT NULL,
    nombre_colegio character varying(200) NOT NULL,
    nombre_director character varying(200) NOT NULL,
    correo character varying(200) NOT NULL,
    telefono character varying(50),
    nro_alumnos_aprox integer,
...
--
-- Name: solicitudes_plan_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.solicitudes_plan_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: solicitudes_plan_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.solicitudes_plan_id_seq OWNED BY public.solicitudes_plan.id;
...
CREATE TABLE public.usuarios (
    ...
    CONSTRAINT usuarios_rol_check CHECK ((rol = ANY (ARRAY['director'::text, 'profesor'::text, 'apoderado'::text, 'alumno'::text, 'superadmin'::text])))
);
...
--
-- Name: anotaciones id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: apoderado_alumno id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apoderado_alumno ALTER COLUMN id SET DEFAULT nextval('public.apoderado_alumno_id_seq'::regclass);
...
--
-- Name: curso_asignatura_profesor id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.curso_asignatura_profesor ALTER COLUMN id SET DEFAULT nextval('public.curso_asignatura_profesor_id_seq'::regclass);
...
--
-- Name: muro_avisos id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.muro_avisos ALTER COLUMN id SET DEFAULT nextval('public.muro_avisos_nuevo_id_seq'::regclass);
...
--
-- Name: notas_historial id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.notas_historial ALTER COLUMN id SET DEFAULT nextval('public.notas_historial_id_seq'::regclass);


--
-- Name: solicitudes_plan id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.solicitudes_plan ALTER COLUMN id SET DEFAULT nextval('public.solicitudes_plan_id_seq'::regclass);
...
--
-- Name: alumnos alumnos_rut_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: anotaciones anotaciones_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: apoderado_alumno apoderado_alumno_id_apoderado_id_alumno_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apoderado_alumno
    ADD CONSTRAINT apoderado_alumno_id_apoderado_id_alumno_key UNIQUE (id_apoderado, id_alumno);


--
-- Name: apoderado_alumno apoderado_alumno_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apoderado_alumno
    ADD CONSTRAINT apoderado_alumno_pkey PRIMARY KEY (id);


--
-- Name: asignaturas asignaturas_nombre_nivel_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asignaturas
    ADD CONSTRAINT asignaturas_nombre_nivel_key UNIQUE (nombre, nivel);
...
--
-- Name: asistencia asistencia_alumno_fecha_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asistencia
    ADD CONSTRAINT asistencia_alumno_fecha_unique UNIQUE (id_alumno, fecha);
...
--
-- Name: colegios colegios_rut_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colegios
    ADD CONSTRAINT colegios_rut_key UNIQUE (rut);


--
-- Name: curso_asignatura_profesor curso_asignatura_profesor_id_curso_id_asignatura_id_profeso_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.curso_asignatura_profesor
    ADD CONSTRAINT curso_asignatura_profesor_id_curso_id_asignatura_id_profeso_key UNIQUE (id_curso, id_asignatura, id_profesor);


--
-- Name: curso_asignatura_profesor curso_asignatura_profesor_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.curso_asignatura_profesor
    ADD CONSTRAINT curso_asignatura_profesor_pkey PRIMARY KEY (id);
...
--
-- Name: muro_avisos muro_avisos_nuevo_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.muro_avisos
    ADD CONSTRAINT muro_avisos_nuevo_pkey PRIMARY KEY (id);


--
-- Name: notas_historial notas_historial_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.notas_historial
    ADD CONSTRAINT notas_historial_pkey PRIMARY KEY (id);
...
--
-- Name: solicitudes_plan solicitudes_plan_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: alumnos alumnos_colegio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumnos_colegio_id_fkey FOREIGN KEY (colegio_id) REFERENCES public.colegios(id) ON DELETE CASCADE;


--
-- Name: alumnos alumnos_id_apoderado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumnos_id_apoderado_fkey FOREIGN KEY (id_apoderado) REFERENCES public.usuarios(id) ON DELETE SET NULL;


--
-- Name: alumnos alumnos_id_curso_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumnos_id_curso_fkey FOREIGN KEY (id_curso) REFERENCES public.cursos(id) ON DELETE CASCADE;


--
-- Name: anotaciones anotaciones_id_alumno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.anotaciones
    ADD CONSTRAINT anotaciones_id_alumno_fkey FOREIGN KEY (id_alumno) REFERENCES public.alumnos(id) ON DELETE CASCADE;


--
-- Name: anotaciones anotaciones_id_profesor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.anotaciones
    ADD CONSTRAINT anotaciones_id_profesor_fkey FOREIGN KEY (id_profesor) REFERENCES public.usuarios(id);


--
-- Name: apoderado_alumno apoderado_alumno_id_alumno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apoderado_alumno
    ADD CONSTRAINT apoderado_alumno_id_alumno_fkey FOREIGN KEY (id_alumno) REFERENCES public.alumnos(id) ON DELETE CASCADE;


--
-- Name: apoderado_alumno apoderado_alumno_id_apoderado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apoderado_alumno
    ADD CONSTRAINT apoderado_alumno_id_apoderado_fkey FOREIGN KEY (id_apoderado) REFERENCES public.usuarios(id) ON DELETE CASCADE;


--
-- Name: asignaturas asignaturas_colegio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asignaturas
    ADD CONSTRAINT asignaturas_colegio_id_fkey FOREIGN KEY (colegio_id) REFERENCES public.colegios(id) ON DELETE CASCADE;


--
-- Name: asistencia asistencia_id_alumno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asistencia
    ADD CONSTRAINT asistencia_id_alumno_fkey FOREIGN KEY (id_alumno) REFERENCES public.alumnos(id) ON DELETE CASCADE;


--
-- Name: curso_asignatura_profesor curso_asignatura_profesor_id_asignatura_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.curso_asignatura_profesor
    ADD CONSTRAINT curso_asignatura_profesor_id_asignatura_fkey FOREIGN KEY (id_asignatura) REFERENCES public.asignaturas(id) ON DELETE CASCADE;


--
-- Name: curso_asignatura_profesor curso_asignatura_profesor_id_curso_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.curso_asignatura_profesor
    ADD CONSTRAINT curso_asignatura_profesor_id_curso_fkey FOREIGN KEY (id_curso) REFERENCES public.cursos(id) ON DELETE CASCADE;


--
-- Name: curso_asignatura_profesor curso_asignatura_profesor_id_profesor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.curso_asignatura_profesor
    ADD CONSTRAINT curso_asignatura_profesor_id_profesor_fkey FOREIGN KEY (id_profesor) REFERENCES public.usuarios(id) ON DELETE CASCADE;


--
-- Name: cursos cursos_colegio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cursos
    ADD CONSTRAINT cursos_colegio_id_fkey FOREIGN KEY (colegio_id) REFERENCES public.colegios(id) ON DELETE CASCADE;


--
-- Name: cursos cursos_id_profesor_jefe_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cursos
    ADD CONSTRAINT cursos_id_profesor_jefe_fkey FOREIGN KEY (id_profesor_jefe) REFERENCES public.usuarios(id) ON DELETE SET NULL;


--
-- Name: evaluaciones evaluaciones_id_asignatura_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.evaluaciones
    ADD CONSTRAINT evaluaciones_id_asignatura_fkey FOREIGN KEY (id_asignatura) REFERENCES public.asignaturas(id) ON DELETE CASCADE;


--
-- Name: evaluaciones evaluaciones_id_curso_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: evaluaciones evaluaciones_id_profesor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.evaluaciones
    ADD CONSTRAINT evaluaciones_id_profesor_fkey FOREIGN KEY (id_profesor) REFERENCES public.usuarios(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.horario
    ADD CONSTRAINT horario_id_curso_fkey FOREIGN KEY (id_curso) REFERENCES public.cursos(id) ON DELETE CASCADE;


--
-- Name: horario horario_id_profesor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.horario
    ADD CONSTRAINT horario_id_profesor_fkey FOREIGN KEY (id_profesor) REFERENCES public.usuarios(id) ON DELETE SET NULL;


--
-- Name: horarios horarios_id_asignatura_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.horarios
    ADD CONSTRAINT horarios_id_asignatura_fkey FOREIGN KEY (id_asignatura) REFERENCES public.asignaturas(id) ON DELETE CASCADE;


--
-- Name: horarios horarios_id_curso_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.horarios
    ADD CONSTRAINT horarios_id_curso_fkey FOREIGN KEY (id_curso) REFERENCES public.cursos(id) ON DELETE CASCADE;


--
-- Name: muro_avisos muro_avisos_nuevo_id_autor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.muro_avisos
    ADD CONSTRAINT muro_avisos_nuevo_id_autor_fkey FOREIGN KEY (id_autor) REFERENCES public.usuarios(id) ON DELETE SET NULL;


--
-- Name: muro_avisos muro_avisos_nuevo_id_curso_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.muro_avisos
    ADD CONSTRAINT muro_avisos_nuevo_id_curso_fkey FOREIGN KEY (id_curso) REFERENCES public.cursos(id) ON DELETE CASCADE;


--
-- Name: notas notas_id_alumno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.notas
    ADD CONSTRAINT notas_id_alumno_fkey FOREIGN KEY (id_alumno) REFERENCES public.alumnos(id) ON DELETE CASCADE;


--
-- Name: notas notas_id_asignatura_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.notas
    ADD CONSTRAINT notas_id_asignatura_fkey FOREIGN KEY (id_asignatura) REFERENCES public.asignaturas(id) ON DELETE SET NULL;


--
-- Name: usuarios usuarios_colegio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.usuarios
    ADD CONSTRAINT usuarios_colegio_id_fkey FOREIGN KEY (colegio_id) REFERENCES public.colegios(id) ON DELETE SET NULL;
...
--
-- Name: colegios; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: TABLE anotaciones; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.anotaciones TO anon;
GRANT ALL ON TABLE public.anotaciones TO authenticated;
GRANT ALL ON TABLE public.anotaciones TO service_role;


--
-- Name: SEQUENCE anotaciones_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.anotaciones_id_seq TO anon;
GRANT ALL ON SEQUENCE public.anotaciones_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.anotaciones_id_seq TO service_role;


--
-- Name: TABLE apoderado_alumno; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.apoderado_alumno TO anon;
GRANT ALL ON TABLE public.apoderado_alumno TO authenticated;
GRANT ALL ON TABLE public.apoderado_alumno TO service_role;


--
-- Name: SEQUENCE apoderado_alumno_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.apoderado_alumno_id_seq TO anon;
GRANT ALL ON SEQUENCE public.apoderado_alumno_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.apoderado_alumno_id_seq TO service_role;


--
-- Name: TABLE asignaturas; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE asignaturas_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE asistencia_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE colegios; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE colegios_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE curso_asignatura_profesor; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.curso_asignatura_profesor TO anon;
GRANT ALL ON TABLE public.curso_asignatura_profesor TO authenticated;
GRANT ALL ON TABLE public.curso_asignatura_profesor TO service_role;


--
-- Name: SEQUENCE curso_asignatura_profesor_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.curso_asignatura_profesor_id_seq TO anon;
GRANT ALL ON SEQUENCE public.curso_asignatura_profesor_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.curso_asignatura_profesor_id_seq TO service_role;
...
--
-- Name: SEQUENCE cursos_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE horario; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE horario_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE muro_avisos; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.muro_avisos TO anon;
GRANT ALL ON TABLE public.muro_avisos TO authenticated;
GRANT ALL ON TABLE public.muro_avisos TO service_role;


--
-- Name: SEQUENCE muro_avisos_nuevo_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.muro_avisos_nuevo_id_seq TO anon;
GRANT ALL ON SEQUENCE public.muro_avisos_nuevo_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.muro_avisos_nuevo_id_seq TO service_role;
...
--
-- Name: TABLE notas_historial; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.notas_historial TO anon;
GRANT ALL ON TABLE public.notas_historial TO authenticated;
GRANT ALL ON TABLE public.notas_historial TO service_role;


--
-- Name: SEQUENCE notas_historial_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.notas_historial_id_seq TO anon;
GRANT ALL ON SEQUENCE public.notas_historial_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.notas_historial_id_seq TO service_role;
...
--
-- Name: TABLE solicitudes_plan; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.solicitudes_plan TO anon;
GRANT ALL ON TABLE public.solicitudes_plan TO authenticated;
GRANT ALL ON TABLE public.solicitudes_plan TO service_role;


--
-- Name: SEQUENCE solicitudes_plan_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.solicitudes_plan_id_seq TO anon;
GRANT ALL ON SEQUENCE public.solicitudes_plan_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.solicitudes_plan_id_seq TO service_role;
...
\unrestrict A7VrgD6P2CW7etWzol96bVWxnCyt6qbOgyoDwyqBhf5YPad9mDIOiuaXivJsXEB
